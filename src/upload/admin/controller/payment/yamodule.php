...
class ControllerPaymentYamodule extends Controller {
	...
	public function sendmail (){
		...
		//TODO Отключить демо
		$url = "https://demomoney.yandex.ru/eshop.xml?".http_build_query($arUrl);
		$logo = (is_file(DIR_IMAGE . $this->config->get('config_logo')))?$order_info['store_url'] . 'image/' . $this->config->get('config_logo'):'';
		$pattern = array(
			'%order_id%' => $order_id,
